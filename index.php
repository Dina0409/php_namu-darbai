echo '<pre>';
    echo'_1uzduotis__________'<b>
        <?php
        function pasisveikinimas ($t) {
            echo "<h1>$t</h1";
        }
        $tekstas= 'labas vakaras !';
        pasisveikinimas($tekstas);//galima rasyti dviem budais ir gausim paimta teksta teisingai
        ...
        echo '<pre>';
            ...
            <br>__________________u2_____________<br>
...
?><br><br>
 ...
 <br>__________________u3_____________<br>
